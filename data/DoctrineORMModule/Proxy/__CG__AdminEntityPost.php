...
class Post extends \Admin\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'titre', 'contenu', '' . "\0" . 'Admin\\Entity\\Post' . "\0" . 'user', '' . "\0" . 'Admin\\Entity\\Post' . "\0" . 'photo', '' . "\0" . 'Admin\\Entity\\Post' . "\0" . 'comment', '' . "\0" . 'Admin\\Entity\\Post' . "\0" . 'categorie', 'inputFilter');
        }
